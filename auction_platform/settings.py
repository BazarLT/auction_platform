...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'anything goes here 456')
...
# Set application password at https://myaccount.google.com/apppasswords if you use Google mail
