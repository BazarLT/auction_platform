...
from .views import home, auction_list, auction_details, create_profile_view, place_bid_view, post_job_offer_view, register_view, order_post_view, profile_view, register_as_master, test_view
import logging
...
def log_urlpatterns():
    urlpatterns = [
        ...
        path('order/post/', order_post_view, name='order_post_view'),  # Ensure this line is present
